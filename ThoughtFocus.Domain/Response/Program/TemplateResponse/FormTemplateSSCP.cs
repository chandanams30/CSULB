...
namespace ThoughtFocus.Domain.Response.Program
{
    public class FormTemplateSSCP
    {
        ...
        public ClassStandingAtTimeOfAdmissionToSSCP ClassStandingAtTimeOfAdmissionToSSCP { get; set; }

        [JsonProperty("Subject Matter Competence")]
        public SubjectMatterCompetence SubjectMatterCompetence { get; set; }
    ...
    public class APPLICANTSCURRENTLYTEACHING
    {
        ...
        public PleaseIndicateYourCurrentTeachingStatus PleaseIndicateYourCurrentTeachingStatus { get; set; }
