...
namespace ThoughtFocus.Common.Workflow.Core.Runtime
{
    ...
    public sealed class RuntimeTimer
    {
        ...
        public void SetTimer (long processId, TimerDefinition timerDefinition)
        {
        ...
        public void UpdateTimer (long processId, TimerDefinition timerDefinition)
        {
            if (timerDefinition.Type != TimerType.ByProcessInstance)
                throw new NotSupportedException();
            var intervalSeconds = (int)Math.Floor(timerDefinition.IntervalTimeInMilliseconds/(double)1000);
        ...
        private void SetTimer (long processId, TimeSpan interval, string name)
        {
