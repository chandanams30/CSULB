...
namespace ThoughtFocus.Common.Workflow.Core.Bus
{
    ...
    public class ExecutionResponseParameters
    {
        ...
        public static ExecutionResponseParametersComplete Create(long processId, long workFlowID,
        ...
        public static ExecutionResponseParametersError Create(long processId,long workFlowID,
                                                               string executedActivityName,
                                                               Exception exception)
        {
