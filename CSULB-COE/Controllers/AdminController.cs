...
namespace CSULB_COE.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public BaseResponse UpsertInternCourseConfig(UpsertCSULBIDForIntern input)
        {
            try
            {
                BaseResponse response = _adminService.UpsertInternCourseConfig(input);
                return response;
            }
            catch (Exception ex)
            {
        ...
        [HttpGet("GetCompleteYourApplicationText")]
        public CompleteYourApplicationResponse GetCompleteYourApplicationText(int applicationId, int programID)
        {
            try
            {
                CompleteYourApplicationResponse response = _adminService.getCompleteYourApplicationText(applicationId, programID);
                return response;
            }
            catch (Exception ex)
            {
                CompleteYourApplicationResponse response = new CompleteYourApplicationResponse();
                response.IsSuccess = false;
                response.Message = "Failed to retrieve data , please try after sometime";
                response.StackTrace = ex.Message;
                _logger.LogError(ex, ex.Message);
        ...
        [HttpPost("UpdateCompleteYourApplicationText")]
        public BaseResponse UpdateCompleteYourApplicationText(CompleteYourApplicationText input)
        {
            try
            {
                BaseResponse response = _adminService.UpdateCompleteYourApplicationText(input);
                return response;
            }
            catch (Exception ex)
            {
